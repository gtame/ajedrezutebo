...
function showMessage()
{
    ...
    $('#equipo').focusout(function(e)
    {
        ...
        if ( this.value!=null)
        {
            ...
            var urlAjax =  "http://127.0.0.1/ajedrez/api.php/inscripciones?filter=equipo,eq," + encodeURI(this.value) ;
    ...
    $('#inscripcionform').on('submit',function(e){
        ...
        if  (validateform(inputsinscripcion))
        {
            ...
            var urlAjax =  "http://127.0.0.1/ajedrez/api.php/inscripciones" ;
